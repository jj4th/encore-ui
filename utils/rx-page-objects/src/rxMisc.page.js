...
exports.rxMisc = {
     ...
     * @deprecated rxMisc.currencyToPennies will be remove in rxPageObjects 4.0.0
     ...
     * @deprecated rxMisc.newDate will be remove in rxPageObjects 4.0.0
     ...
     * @deprecated rxMisc.negate will be remove in rxPageObjects 4.0.0
     ...
     * @deprecated rxMisc.nullValueMatches will be remove in rxPageObjects 4.0.0
     * @example
     * var userPage {
     ...
     * @function
     * @deprecated rxMisc.unless will be remove in rxPageObjects 4.0.0
     ...
     * @deprecated rxMisc.scrollPosition will be remove in rxPageObjects 4.0.0
     ...
     * @deprecated rxMisc.compareYLocations will be remove in rxPageObjects 4.0.0
     ...
     * @deprecated rxMisc.compareXLocations will be remove in rxPageObjects 4.0.0
     ...
     * @private
     * @function
     * @deprecated rxMisc.transformLocation will be remove in rxPageObjects 4.0.0
